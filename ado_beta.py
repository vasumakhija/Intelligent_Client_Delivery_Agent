...
seed_beta.py
-------------------
Seeds Azure DevOps with all items for Project Beta (P002).
  Client: Fabrikam

STRATEGY (two-step per work item):
  Step 1 — Create in "New" state (always valid).
  Step 2 — PATCH to the target state.

USAGE:
  python seed_beta.py --pat <token>
  python seed_beta.py --dry-run
  python seed_beta.py --pat <token> --org myorg --project myproject
"""
...
PROJECT = os.environ.get("AZURE_DEVOPS_PROJECT",  "Beta")
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# Project-specific data — Beta (P002)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
SPRINTS = {
    "S1": {"name": "Beta Sprint 1", "start": "2026-03-01", "end": "2026-03-14", "status": "Completed"},
    "S2": {"name": "Beta Sprint 2", "start": "2026-03-15", "end": "2026-03-28", "status": "In Progress"},
}

# Work Items: (sprint_id, type, title, state, story_points, priority, assigned_to, blocked)
WORK_ITEMS = [
    ("S1", "Issue", "Design finance insights landing page", "Closed", 5, 2, "David", False),
    ("S1", "Issue", "Create GL summary widgets", "Active", 8, 1, "Emma", False),
    ("S1", "Task", "Map source entities to D365 schema", "Closed", 5, 1, "Frank", False),
    ("S1", "Issue", "[Bug] Resolve data duplication issue", "Active", 3, 1, "David", True),
    ("S2", "Issue", "Build vendor payment trend page", "Active", 8, 2, "Emma", False),
    ("S2", "Task", "Implement drill-through navigation", "New", 5, 2, "Frank", False),
    ("S2", "Task", "Validate finance measures", "Closed", 4, 1, "David", False),
    ("S2", "Issue", "[Bug] Fix missing ledger filter bug", "Active", 3, 1, "Emma", False),
]

# Milestones: (name, due_date, status, delay_days, owner, notes)
MILESTONES = [
    ("Requirements Signoff", "2026-03-13", "Completed", 0, "Lohith", "Completed after minor edits"),
    ("Data Validation", "2026-03-24", "Delayed", 3, "Lohith", "Finance mapping review took longer"),
    ("UAT Start", "2026-04-08", "Watchlist", 2, "Lohith", "Dependent on open bug fixes"),
]

# Risks: (title, severity, status, mitigation, owner)
RISKS = [
    ("Finance data mapping inconsistency", "Medium", "Open", "Freeze mapping and validate source fields", "Lohith"),
    ("Open defect may delay UAT", "Medium", "Open", "Prioritize bug fixing in current sprint", "Lohith"),
]
...
PROJECT_INFO = {
    ...
    "delivery_type":       "D365",
    "project_manager":     "Lohith",
    "start_date":          "2026-03-05",
    "target_end_date":     "2026-06-10",
    "current_status":      "Active",
    "priority":            "Medium",
    "planned_total_hours": 300,
}
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Seed Azure DevOps — Beta (P002)")
    ...
    print()
    print(SEP)
    print("  Azure DevOps Seeder — Beta (P002)")
    print(SEP)
    print("  Org:       " + ORG)
    ...
    print()
    print(SEP)
    print("  DONE — Beta (P002) seeding complete")
    print(SEP)
    print()
