...
seed_alpha.py
-------------------
Seeds Azure DevOps with all items for Project Alpha (P001).
  Client: Contoso
...
USAGE:
  python seed_alpha.py --pat <token>
  python seed_alpha.py --dry-run
  python seed_alpha.py --pat <token> --org myorg --project myproject
"""
...
PROJECT = os.environ.get("AZURE_DEVOPS_PROJECT",  "Alpha")
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# Project-specific data — Alpha (P001)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
SPRINTS = {
    "S1": {"name": "Alpha Sprint 1", "start": "2026-03-01", "end": "2026-03-14", "status": "Completed"},
    "S2": {"name": "Alpha Sprint 2", "start": "2026-03-15", "end": "2026-03-28", "status": "In Progress"},
}

# Work Items: (sprint_id, type, title, state, story_points, priority, assigned_to, blocked)
WORK_ITEMS = [
    ("S1", "Issue", "Build sales dashboard wireframe", "Closed", 5, 2, "Alice", False),
    ("S1", "Issue", "Create customer segmentation visuals", "Closed", 8, 2, "Bob", False),
    ("S1", "Task", "Set up dataset refresh pipeline", "Closed", 3, 1, "Charlie", False),
    ("S1", "Issue", "[Bug] Fix tooltip formatting issue", "Resolved", 2, 2, "Alice", False),
    ("S2", "Issue", "Publish executive summary page", "Active", 8, 2, "Bob", False),
    ("S2", "Task", "Validate KPI calculations", "Closed", 5, 1, "Charlie", False),
    ("S2", "Task", "Optimize report performance", "Closed", 5, 2, "Alice", False),
    ("S2", "Issue", "[Bug] Fix slicer sync issue", "Closed", 3, 2, "Bob", False),
]

# Milestones: (name, due_date, status, delay_days, owner, notes)
MILESTONES = [
    ("Requirements Signoff", "2026-03-12", "Completed", 0, "Lohith", "Completed on schedule"),
    ("Prototype Demo", "2026-03-22", "Completed", 0, "Lohith", "Demo approved by stakeholders"),
    ("UAT Start", "2026-04-05", "On Track", 0, "Lohith", "No dependency issues"),
]

# Risks: (title, severity, status, mitigation, owner)
RISKS = [
    ("Minor visual alignment clarification", "Low", "Open", "Resolve during next client sync", "Lohith"),
]
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Seed Azure DevOps — Alpha (P001)")
    ...
    print()
    print(SEP)
    print("  Azure DevOps Seeder — Alpha (P001)")
    print(SEP)
    print("  Org:       " + ORG)
    ...
    print()
    print(SEP)
    print("  DONE — Alpha (P001) seeding complete")
    print(SEP)
    print()
